...
To install plugin, [download the latest version](https://github.com/michaelsroadster/acc-obs-plugin/releases/tag/latest), extract the DLL file to “obs-plugins\64bit” folder of your OBS Studio installation and restart the OBS Studio. Also, make sure you have OBS Integration in Small Tweaks settings enabled.
